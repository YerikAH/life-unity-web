    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto mt-20 max-w-lg space-y-16">
        <div className="flex gap-x-6">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-yellow-600">
          ...
          <div>
            ...
            <p className="mt-4">
              <a href="#" className="active:scale-95 text-sm font-semibold leading-6 text-yellow-600">
